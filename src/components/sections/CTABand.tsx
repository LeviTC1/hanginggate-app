...
export default function CTABand({ className }: CTABandProps) {
  return (
    <section className={`relative overflow-hidden bg-[var(--surface-dark)] py-16 md:py-24 ${className ?? ''}`}>
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_120%_60%_at_30%_50%,rgba(76,116,70,0.28)_0%,transparent_70%)]" />

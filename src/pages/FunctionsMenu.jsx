  ...
  return (
    <div>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '64px 24px' }}>
        ...
        <div style={{ backgroundColor: '#F0EBE0', borderRadius: '8px', padding: '20px 24px', marginBottom: '40px', fontSize: '14px', color: '#4A3D34', lineHeight: 1.7 }}>
        ...
        <div style={{ marginBottom: '48px' }}>
          ...
          <div style={{ backgroundColor: '#FAF7F2', border: '1px solid #E8DFD0', borderRadius: '8px', padding: '20px' }}>
            <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '18px', color: '#8B1A1A', marginBottom: '16px' }}>Drinks Packages</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
              <div style={{ padding: '16px', backgroundColor: '#F0EBE0', borderRadius: '6px' }}>
                <div style={{ fontWeight: 700, color: '#8B1A1A', marginBottom: '8px' }}>Menu 1 — £14.95 per head</div>
                <ul style={{ paddingLeft: '16px', fontSize: '14px', color: '#4A3D34', lineHeight: 1.7 }}>
              ...
              <div style={{ padding: '16px', backgroundColor: '#F0EBE0', borderRadius: '6px' }}>
                <div style={{ fontWeight: 700, color: '#8B1A1A', marginBottom: '8px' }}>Menu 2 — £21.95 per head</div>
                <ul style={{ paddingLeft: '16px', fontSize: '14px', color: '#4A3D34', lineHeight: 1.7 }}>
        ...
        <div style={{ marginBottom: '48px' }}>
          ...
          <p style={{ color: '#6B5E52', fontSize: '15px', marginBottom: '20px' }}>£13.95 per head Mon–Thu · £15.95 per head Fri–Sun</p>
          <div style={{ backgroundColor: '#FAF7F2', border: '1px solid #E8DFD0', borderRadius: '8px', padding: '24px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '8px' }}>
              {[
                ...
                <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                  ...
                  <span style={{ color: '#4A3D34', fontSize: '14px' }}>{i}</span>
                </div>
              ))}
            </div>
            <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid #E8DFD0' }}>
              <div style={{ fontWeight: 600, color: '#8B1A1A', marginBottom: '8px', fontSize: '14px' }}>Optional extras at additional cost:</div>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                {['Roast Derbyshire Turkey', 'Coronation Chicken', 'Home-Made Pâté & Melba Toast', 'Chilled Melon', 'Egg Mayonnaise', 'Hot Vegetable Samosa', 'Hot New/Chipped Potatoes', 'Spicy Wedges', 'Charcuterie Board', 'Greek Salad', 'Nachos & Dips'].map(e => (
                  <span key={e} style={{ backgroundColor: '#F0EBE0', color: '#6B5E52', padding: '4px 10px', borderRadius: '20px', fontSize: '13px' }}>{e}</span>
                ))}
              </div>
            </div>
          </div>
        ...
        {/* Table plans */}
        <div style={{ backgroundColor: '#FAF7F2', border: '1px solid #E8DFD0', borderRadius: '8px', padding: '24px', marginBottom: '16px' }}>
          <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '20px', color: '#8B1A1A', marginBottom: '12px' }}>Table Plans</h3>
          <p style={{ color: '#4A3D34', fontSize: '15px', lineHeight: 1.7, marginBottom: '8px' }}>
        ...
        {/* Flowers */}
        <div style={{ backgroundColor: '#FAF7F2', border: '1px solid #E8DFD0', borderRadius: '8px', padding: '24px', marginBottom: '16px' }}>
          <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '20px', color: '#8B1A1A', marginBottom: '12px' }}>Flowers</h3>
          <p style={{ color: '#4A3D34', fontSize: '15px', lineHeight: 1.7 }}>
        ...
        {/* Entertainment */}
        <div style={{ backgroundColor: '#FAF7F2', border: '1px solid #E8DFD0', borderRadius: '8px', padding: '24px', marginBottom: '24px' }}>
          <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '20px', color: '#8B1A1A', marginBottom: '12px' }}>Entertainment</h3>
          <p style={{ color: '#4A3D34', fontSize: '15px', lineHeight: 1.7 }}>
        ...
        {/* Reservations */}
        <div style={{ backgroundColor: '#8B1A1A', borderRadius: '8px', padding: '32px', color: 'white' }}>
          <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '22px', color: '#E2C97E', marginBottom: '16px' }}>Reservations & Payment</h3>
          ...
          <a href="tel:01298812776" style={{ display: 'inline-block', marginTop: '20px', backgroundColor: '#E2C97E', color: '#3D0808', padding: '12px 28px', borderRadius: '4px', fontWeight: 700, fontSize: '16px', textDecoration: 'none' }}>

...
export default function Children() {
  return (
    <div>
      <SEO path="/children" description="The Hanging Gate is officially Baby Friendly with a dedicated parent & baby room, colouring corner and children's menu in Chapel-en-le-Frith." />
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '64px 24px' }}>
        ...
        {/* Intro */}
        <p style={{ color: '#4A3D34', fontSize: '17px', lineHeight: 1.9, marginBottom: '20px' }}>
        ...
        <p style={{ color: '#4A3D34', fontSize: '17px', lineHeight: 1.9, marginBottom: '48px' }}>
          ...
          <Link to="/menus/bar-restaurant" style={{ color: '#8B1A1A', fontWeight: 600 }}>Bar/Restaurant menu</Link>.
        </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '24px', marginBottom: '56px' }}>
          ...
          <div style={{ backgroundColor: '#FAF7F2', border: '1px solid #E8DFD0', borderRadius: '10px', padding: '28px 24px' }}>
            <div style={{ fontSize: '36px', marginBottom: '12px' }}>👶</div>
            <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '20px', color: '#8B1A1A', marginBottom: '10px' }}>
              Officially Baby Friendly
            </h3>
            <p style={{ color: '#4A3D34', fontSize: '14px', lineHeight: 1.8 }}>
          ...
          <div style={{ backgroundColor: '#FAF7F2', border: '1px solid #E8DFD0', borderRadius: '10px', padding: '28px 24px' }}>
            ...
            <Link to="/menus/bar-restaurant" style={{ display: 'inline-block', marginTop: '12px', color: '#8B1A1A', fontWeight: 600, fontSize: '14px', textDecoration: 'none' }}>
        ...
        <div style={{ backgroundColor: '#8B1A1A', borderRadius: '10px', padding: '36px', textAlign: 'center', color: 'white' }}>
          <p style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '22px', color: '#E2C97E', marginBottom: '12px', fontStyle: 'italic' }}>

    ...
    <div>
      ...
      <section style={{ maxWidth: '760px', margin: '0 auto', padding: '64px 24px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          <div style={{ borderLeft: '3px solid var(--surface-dark-2)', paddingLeft: '24px' }}>
            <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '22px', color: 'var(--surface-dark-2)', marginBottom: '12px' }}>
              The Origins
            </h3>
        ...
        <div style={{ marginTop: '56px', backgroundColor: 'var(--surface-warm)', borderRadius: '8px', padding: '32px', textAlign: 'center' }}>
          <p style={{ fontFamily: 'var(--font-display)', fontSize: '22px', fontStyle: 'italic', color: 'var(--surface-dark-2)' }}>
